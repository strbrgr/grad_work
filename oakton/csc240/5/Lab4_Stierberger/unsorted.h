...
public:
  ...
  void DoubleSize();
  // Function: Doubles the size of the original array
  // Pre: List has been initialized and is almost full
  // Post: List has twice the original size and all elements are copied over
